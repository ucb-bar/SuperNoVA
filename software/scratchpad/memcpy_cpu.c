...
int main() {
    ...
    static elem_t A[MAT_DIM_I][MAT_DIM_J] byte_align(DMA_MAX_BYTES);
    static elem_t B[MAT_DIM_I][MAT_DIM_J] byte_align(DMA_MAX_BYTES);
    static elem_t C[MAT_DIM_I][MAT_DIM_J] byte_align(DMA_MAX_BYTES);
