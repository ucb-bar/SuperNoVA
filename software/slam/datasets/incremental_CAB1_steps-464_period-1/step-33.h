...
int step33_factor88_ridx[] = {24, 25, 26, 27, 28, 29, 42, 43, 44, 45, 46, 47, 48, };
float step33_factor88_data[78] = {0};

const int step33_factor88_num_blks = 2;
int step33_factor88_A_blk_start[] = {0, 6, };
int step33_factor88_B_blk_start[] = {24, 42, };
int step33_factor88_blk_width[] = {6, 6, };

const int step33_node6_num_factors = 4;
const int step33_node6_relin_cost = 120000;
const bool step33_node6_marked = false;
const bool step33_node6_fixed = true;
int step33_node6_factor_height[] = {step33_factor88_height, step33_factor89_height, step33_factor90_height, step33_factor91_height, };
int step33_node6_factor_width[] = {step33_factor88_width, step33_factor89_width, step33_factor90_width, step33_factor91_width, };
int* step33_node6_factor_ridx[] = {step33_factor88_ridx, step33_factor89_ridx, step33_factor90_ridx, step33_factor91_ridx, };
float* step33_node6_factor_data[] = {step33_factor88_data, step33_factor89_data, step33_factor90_data, step33_factor91_data, };
int step33_node6_factor_num_blks[] = {step33_factor88_num_blks, step33_factor89_num_blks, step33_factor90_num_blks, step33_factor91_num_blks, };
int* step33_node6_factor_A_blk_start[] = {step33_factor88_A_blk_start, step33_factor89_A_blk_start, step33_factor90_A_blk_start, step33_factor91_A_blk_start, };
int* step33_node6_factor_B_blk_start[] = {step33_factor88_B_blk_start, step33_factor89_B_blk_start, step33_factor90_B_blk_start, step33_factor91_B_blk_start, };
int* step33_node6_factor_blk_width[] = {step33_factor88_blk_width, step33_factor89_blk_width, step33_factor90_blk_width, step33_factor91_blk_width, };
const int step33_node6_parent = 7;
const int step33_node6_height = 49;
const int step33_node6_width = 42;
float step33_node6_data[2058] = {0};
const int step33_node6_num_blks = 1;
int step33_node6_A_blk_start[] = {0, };
int step33_node6_B_blk_start[] = {0, };
int step33_node6_blk_width[] = {6, };


const int step33_node7_num_factors = 3;
const int step33_node7_relin_cost = 90000;
const bool step33_node7_marked = true;
const bool step33_node7_fixed = false;
int step33_node7_factor_height[] = {step33_factor87_height, step33_factor92_height, step33_factor93_height, };
int step33_node7_factor_width[] = {step33_factor87_width, step33_factor92_width, step33_factor93_width, };
int* step33_node7_factor_ridx[] = {step33_factor87_ridx, step33_factor92_ridx, step33_factor93_ridx, };
float* step33_node7_factor_data[] = {step33_factor87_data, step33_factor92_data, step33_factor93_data, };
int step33_node7_factor_num_blks[] = {step33_factor87_num_blks, step33_factor92_num_blks, step33_factor93_num_blks, };
int* step33_node7_factor_A_blk_start[] = {step33_factor87_A_blk_start, step33_factor92_A_blk_start, step33_factor93_A_blk_start, };
int* step33_node7_factor_B_blk_start[] = {step33_factor87_B_blk_start, step33_factor92_B_blk_start, step33_factor93_B_blk_start, };
int* step33_node7_factor_blk_width[] = {step33_factor87_blk_width, step33_factor92_blk_width, step33_factor93_blk_width, };
const int step33_node7_parent = 8;
const int step33_node7_height = 13;
const int step33_node7_width = 12;
float step33_node7_data[156] = {0};
...
const int step33_workspace_needed = 10584;
