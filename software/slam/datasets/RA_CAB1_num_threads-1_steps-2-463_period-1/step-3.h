...
const uint64_t step3_scaled_relin_cost = 60000;
...
const int step3_node0_relin_cost = 60000;
const int step3_node0_sym_cost = 16000;
...
const int step3_node1_sym_cost = 4000;
...
int step3_node_sym_cost[] = {step3_node0_sym_cost, step3_node1_sym_cost, };
